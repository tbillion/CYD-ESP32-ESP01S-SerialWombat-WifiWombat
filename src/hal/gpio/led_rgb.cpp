...
// Predefined colors
void rgbLedRed()     { rgbLedSetColor(255, 0, 0); }
void rgbLedGreen()   { rgbLedSetColor(0, 255, 0); }
void rgbLedBlue()    { rgbLedSetColor(0, 0, 255); }
void rgbLedYellow()  { rgbLedSetColor(255, 255, 0); }
void rgbLedCyan()    { rgbLedSetColor(0, 255, 255); }
void rgbLedMagenta() { rgbLedSetColor(255, 0, 255); }
void rgbLedWhite()   { rgbLedSetColor(255, 255, 255); }
void rgbLedOff()     { rgbLedSetColor(0, 0, 0); }
