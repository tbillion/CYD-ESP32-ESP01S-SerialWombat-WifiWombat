...
void BootManager::bootComplete() {
  ...
  if (summary_.boot_degraded) {
    msg_warn("boot", BOOT_DEGRADED, "Boot Complete (Degraded)",
             "System operational with %d errors, %d warnings", summary_.error_count,
             summary_.warn_count);
  } else {
    msg_info("boot", BOOT_OK_READY, "Boot Complete", "System ready for operation");
  }
}
...
const char* BootManager::getStageName(BootStage stage) {
  switch (stage) {
    case BootStage::BOOT_START:
      return "Boot Start";
    case BootStage::BOOT_01_EARLY:
      return "Early Initialization";
    case BootStage::BOOT_02_CONFIG:
      return "Configuration Load";
    case BootStage::BOOT_03_FILESYSTEM:
      return "Filesystem Mount";
    case BootStage::BOOT_04_SD:
      return "SD Card";
    case BootStage::BOOT_05_DISPLAY:
      return "Display Init";
    case BootStage::BOOT_06_TOUCH:
      return "Touch Init";
    case BootStage::BOOT_07_NETWORK:
      return "Network Init";
    case BootStage::BOOT_08_TIME:
      return "Time Sync";
    case BootStage::BOOT_09_SERVICES:
      return "Services Start";
    case BootStage::BOOT_10_SELFTEST:
      return "Self Tests";
    case BootStage::BOOT_COMPLETE:
...
const char* BootManager::getBeginCode(BootStage stage) {
  switch (stage) {
    case BootStage::BOOT_01_EARLY:
      return BOOT_01_EARLY_BEGIN;
    case BootStage::BOOT_02_CONFIG:
      return BOOT_02_CONFIG_BEGIN;
    case BootStage::BOOT_03_FILESYSTEM:
      return BOOT_03_FS_BEGIN;
    case BootStage::BOOT_04_SD:
      return BOOT_04_SD_BEGIN;
    case BootStage::BOOT_05_DISPLAY:
      return BOOT_05_DISPLAY_BEGIN;
    case BootStage::BOOT_06_TOUCH:
      return BOOT_06_TOUCH_BEGIN;
    case BootStage::BOOT_07_NETWORK:
      return BOOT_07_NET_BEGIN;
    case BootStage::BOOT_08_TIME:
      return BOOT_08_TIME_BEGIN;
    case BootStage::BOOT_09_SERVICES:
      return BOOT_09_SERVICES_BEGIN;
    case BootStage::BOOT_10_SELFTEST:
      return BOOT_10_SELFTEST_BEGIN;
    default:
      return nullptr;
  }
}
...
const char* BootManager::getOkCode(BootStage stage) {
  switch (stage) {
    case BootStage::BOOT_01_EARLY:
      return BOOT_01_EARLY_OK;
    case BootStage::BOOT_02_CONFIG:
      return BOOT_02_CONFIG_OK;
    case BootStage::BOOT_03_FILESYSTEM:
      return BOOT_03_FS_OK;
    case BootStage::BOOT_04_SD:
      return BOOT_04_SD_OK;
    case BootStage::BOOT_05_DISPLAY:
      return BOOT_05_DISPLAY_OK;
    case BootStage::BOOT_06_TOUCH:
      return BOOT_06_TOUCH_OK;
    case BootStage::BOOT_07_NETWORK:
      return BOOT_07_NET_OK;
    case BootStage::BOOT_08_TIME:
      return BOOT_08_TIME_OK;
    case BootStage::BOOT_09_SERVICES:
      return BOOT_09_SERVICES_OK;
    case BootStage::BOOT_10_SELFTEST:
      return BOOT_10_SELFTEST_OK;
    default:
      return nullptr;
  }
}
...
const char* BootManager::getWarnCode(BootStage stage) {
  switch (stage) {
    case BootStage::BOOT_02_CONFIG:
      return BOOT_02_CONFIG_WARN;
    case BootStage::BOOT_04_SD:
      return BOOT_04_SD_NOT_PRESENT;
    case BootStage::BOOT_05_DISPLAY:
      return BOOT_05_DISPLAY_DISABLED;
    case BootStage::BOOT_06_TOUCH:
      return BOOT_06_TOUCH_FAIL;
    case BootStage::BOOT_07_NETWORK:
      return BOOT_07_NET_AP_FALLBACK;
    case BootStage::BOOT_08_TIME:
      return BOOT_08_TIME_FAIL;
    case BootStage::BOOT_09_SERVICES:
      return BOOT_09_OTA_FAIL;
    case BootStage::BOOT_10_SELFTEST:
      return BOOT_10_SELFTEST_FAIL;
    default:
      return nullptr;
  }
}
...
const char* BootManager::getFailCode(BootStage stage) {
  switch (stage) {
    case BootStage::BOOT_02_CONFIG:
      return BOOT_02_CONFIG_FAIL;
    case BootStage::BOOT_03_FILESYSTEM:
      return BOOT_03_FS_FAIL;
    case BootStage::BOOT_04_SD:
      return BOOT_04_SD_FAIL;
    case BootStage::BOOT_05_DISPLAY:
      return BOOT_05_DISPLAY_FAIL;
    case BootStage::BOOT_07_NETWORK:
      return BOOT_07_NET_FAIL;
    case BootStage::BOOT_09_SERVICES:
      return BOOT_09_WEB_FAIL;
    default:
      return nullptr;
  }
}
