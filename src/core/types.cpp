...
const char* panelToStr(PanelKind p) {
  switch (p) {
    case PANEL_NONE: return "NONE";
    case PANEL_SPI_ILI9341: return "ILI9341";
    case PANEL_SPI_ST7789: return "ST7789";
    case PANEL_SPI_ST7796: return "ST7796";
    case PANEL_RGB_800x480: return "RGB_800x480";
    default: return "UNKNOWN";
  }
}
...
const char* touchToStr(TouchKind t) {
  switch (t) {
    ...
    case TOUCH_XPT2046: return "XPT2046";
    case TOUCH_GT911: return "GT911";
    case TOUCH_I2C_GENERIC: return "I2C_GENERIC";
    default: return "UNKNOWN";
  }
}
